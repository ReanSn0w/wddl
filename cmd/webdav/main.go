...
var (
	...
	opts     = struct {
		...
		Interval int    `long:"interval" env:"INTERVAL" default:"3" description:"sync retry interval. [default: 3] eq 3 seconds"`
	}{}
)
...
func main() {
	...
	s.Start(app.Context(), time.Second*time.Duration(opts.Interval))
